...
\tikzset{
    png copy/.style={
        external/system call={
            pdflatex \tikzexternalcheckshellescape -halt-on-error -interaction=batchmode -jobname "\image" "\texsource" & convert -density 300 -transparent white "\image.pdf" "\image.png"
        }
    }
}
\tikzset{png copy}
...
\begin{table}[H]
\caption{A table\label{tab:TheTable}}
\centering
\begin{tabular}{ccc}
\hline 
C1 & C2 & C3 \\ \hline
